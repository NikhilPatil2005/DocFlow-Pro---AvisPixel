...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <a href="index.php?action=admin_dashboard&status=pending" class="block">
            <div
                class="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500 hover:bg-blue-100 transition cursor-pointer">
        ...
        <a href="index.php?action=admin_dashboard&status=published" class="block">
            <div
                class="bg-green-50 p-4 rounded-lg border-l-4 border-green-500 hover:bg-green-100 transition cursor-pointer">
        ...
        <a href="index.php?action=admin_dashboard&status=rejected" class="block">
    ...
    <div class="mt-8 bg-blue-50 p-6 rounded-lg border border-blue-200">
        <h3 class="text-xl font-bold text-blue-800 mb-2">Welcome to the Admin Dashboard</h3>
        <p class="text-gray-700">
            Use the sidebar to navigate to <strong>Registration Requests</strong> to approve new users, or
            <strong>Create Notice</strong> to broadcast announcements.
        </p>
    </div>
