...
<div class="bg-white rounded-lg shadow-md p-6">
    <h2 class="text-2xl font-bold mb-4 text-gray-800">HOD Dashboard</h2>
    <p class="mb-4 text-gray-600">Department: <span class="font-semibold"><?php echo htmlspecialchars($departmentName); ?></span></p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <div class="bg-green-50 p-4 rounded-lg border border-green-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-green-600 font-medium">Department Staff</p>
    ...
    <?php if ($departmentName === 'Not Assigned'): ?>
    <div class="bg-red-50 p-4 rounded-lg border border-red-200 mb-6">
        <p class="text-red-800 font-medium">You are not assigned to any department. Please contact Admin to assign you to a department.</p>
    </div>
    <?php endif; ?>
    ...
    <div class="mt-8">
        <h3 class="text-xl font-bold text-gray-800 mb-4">Pending Leave Requests (From Teachers)</h3>
    ...
    <div class="mt-8 bg-gray-50 p-6 rounded-lg border border-gray-200 text-center">
        <p class="text-gray-600">No pending leave requests from teachers in your department.</p>
    </div>
    <?php endif; ?>
</div>
