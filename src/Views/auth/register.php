...
<head>
    ...
    <title>Register - Faculty Management System</title>
    ...
    <div class="max-w-md w-full mx-auto bg-white rounded-xl shadow-lg p-8">
        <div class="text-center mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">
                Already have an account? <a href="index.php?action=login"
                    class="font-medium text-primary hover:text-indigo-500">Sign in</a>
            </p>
        </div>
            ...
            <div id="document-fields" class="space-y-4 hidden">
                ...
                <div id="doc-admin" class="hidden doc-group">
                    <div>
                        ...
                        <input type="file" name="identity_proof" accept=".pdf,.jpg,.jpeg,.png"
                            class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                    </div>
                    <div class="mt-3">
                        <label class="block text-sm font-medium text-gray-700">Appointment Letter</label>
                        <input type="file" name="appointment_letter" accept=".pdf,.jpg,.jpeg,.png"
                            class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                    </div>
                </div>
                ...
                <div id="doc-teacher" class="hidden doc-group">
                    <div>
                        ...
                        <input type="file" name="educational_certificates" accept=".pdf,.jpg,.jpeg,.png"
                            class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                    </div>
                    <div class="mt-3">
                        <label class="block text-sm font-medium text-gray-700">College ID Card</label>
                        <input type="file" name="college_id_card" accept=".pdf,.jpg,.jpeg,.png"
                            class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                    </div>
                </div>
                ...
                <div id="doc-student" class="hidden doc-group">
                    <div>
                        ...
                        <input type="file" name="admission_receipt" accept=".pdf,.jpg,.jpeg,.png"
                            class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                    </div>
                    <div class="mt-3">
                        <label class="block text-sm font-medium text-gray-700">Previous Year Marksheet</label>
                        <input type="file" name="previous_marksheet" accept=".pdf,.jpg,.jpeg,.png"
                            class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                    </div>
                </div>
                ...
                <div id="key-super-admin" class="hidden doc-group">
                    ...
                    <input type="password" name="master_key"
